--========================================================================================--
-- Связи многие ко многим - дисциплины к мероприятию 
...
-- Добовляем уникальный индекс, что бы избежать повторений
...
--========================================================================================--
 ...
 -- Связи многие ко многим - возвростные группы к мероприятию
...
CREATE UNIQUE INDEX "UI_age_group_to_competition_competition_id_age_group_id"
 ...
 -- Связи многие ко многим - организаторы к мероприятию
...
--========================================================================================--
 ...
 -- Связи многие ко многим - сообщества к мероприятию
...
CREATE UNIQUE INDEX "UI_communities_to_competition_competition_id_communities_id"
 ...
 --========================================================================================--
  ...
  -- Связи многие ко многим - сооружения к объектам
...
--========================================================================================--
  ...
  -- Связи многие ко многим - сооружения к мероприятиям
...
--========================================================================================--
 ...
 -- Связи многие ко многим - объекты к мероприятиям
